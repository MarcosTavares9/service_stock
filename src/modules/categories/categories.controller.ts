...
export class CategoriesController {
  ...
  @ApiOperation({ 
    ...
    description: 'Retorna uma lista completa de todas as categorias cadastradas no sistema, incluindo nome e ícone associado.'
  })
  @ApiResponse({ 
    status: 200, 
  ...
  @ApiOperation({ 
    ...
    description: 'Retorna os detalhes completos de uma categoria específica identificada pelo seu UUID.'
  })
  ...
  @ApiOperation({ 
    ...
    description: 'Remove uma categoria do sistema. Só é permitida se não houver produtos associados.'
  })
